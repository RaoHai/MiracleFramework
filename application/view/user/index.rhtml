		...
		<div id="header1">登录</div>
			<div id="inner">
				<form name="login" action="login.php" method="post" >
				 ...
				 <p style="color:grey"><a id="password">还没有帐号？</a><a href=# onClick='top.location.href="register.html"'>点这里注册</a></p>
				 </br>
				 <p class='button'><a  href=# onclick= "checkon()"> 登录 </a> </p>
...
登录页面结束
-->
<div id="fade" class="black_overlay" onclick='hideWin(); return false'></div>
<div id="index">
	<div id="header">
		<div id="hd-link">
						{@user}
